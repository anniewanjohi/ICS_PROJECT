...
const LandingPage = () => {
  ...
  // ✅ Check for existing token and redirect - runs only once
  useEffect(() => {
    ...
    if (token && userData) {
      ...
      // ✅ Use replace to prevent back-button glitching
  ...
  // ✅ Handle login success with replace
      ...
      <style>{`
        ...
        * {
        ...
        .btn-primary {
          background: var(--gold);
          color: var(--navy-deep);
          box-shadow: 0 6px 18px -8px rgba(217, 166, 83, 0.7);
        }
        ...
        .kiosk {
          ...
          padding: 26px;
          color: var(--paper);
          box-shadow: 0 30px 60px -30px rgba(11, 37, 66, 0.55);
          position: relative;
          isolation: isolate;
        }
        ...
        .kiosk-dot {
          ...
          box-shadow: 0 0 0 4px rgba(62, 142, 99, 0.18);
        ...
        .feature-card:hover {
          ...
          box-shadow: 0 18px 40px -24px rgba(11, 37, 66, 0.35);
        }
        ...
        [data-theme="dark"] .step-number .num {
          color: var(--gold);
        }
        ...
        <nav>
          ...
          <div className="nav-cta">
            ...
            {isLoggedIn ? (
              ...
              <>
                <button onClick={() => setAuthModalOpen(true)} className="btn btn-ghost btn-small">
                  Sign in
                </button>
                <button onClick={() => setAuthModalOpen(true)} className="btn btn-primary btn-small">
                  Search directory
                </button>
              </>
            )}
        ...
        <div className="wrap hero-grid">
          <div className="reveal in">
            ...
            <div className="hero-actions">
              <button onClick={() => setAuthModalOpen(true)} className="btn btn-primary">
